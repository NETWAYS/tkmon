...
Received: from zimbra.thomas-krenn.com (LHLO zimbra.thomas-krenn.com)
 ...
 +0100 (CET)
Received: from localhost (localhost [127.0.0.1]) by zimbra.thomas-krenn.com 
 (Postfix) with ESMTP id 7CCCA6FC14F for <gschoenberger@thomas-krenn.com>; 
...
Received: from zimbra.thomas-krenn.com ([127.0.0.1]) by localhost 
 (zimbra.thomas-krenn.com [127.0.0.1]) (amavisd-new, port 10024) with ESMTP id
 8gezUBqaX3f0 for <gschoenberger@thomas-krenn.com>; Mon,  5 Nov 2012 15:08:10
 +0100 (CET)
Received: from zimbra.thomas-krenn.com (zimbra.thomas-krenn.com [127.0.1.1])
 by zimbra.thomas-krenn.com (Postfix) with ESMTP id 377216FC14D for
 <gschoenberger@thomas-krenn.com>; Mon,  5 Nov 2012 15:08:10 +0100 (CET)
...
X-Mailer: Zimbra 7.2.0_GA_2669 (ZimbraWebClient - FF3.0
 (Linux)/7.2.0_GA_2669)
...
is(toString($email),$email_str,'email to string method');